...
typedef struct Infis_Image
{
	char	*pImage;
	int		nImageLen;
	int		nFgp;
	//int		nWidth;		//already pad to 640 * 640
	//int		nHeight;
}Infis_Image;
...
*/
extern "C"
INFIS_SPLITBOX_DECL int INFIS_CutImage(int nCaptureType, unsigned char* imagebuff, int nImgWidth, int nImgHeight, void *pWnd, int nImageType, Infis_Image **ppstImg, int *pnCount);
