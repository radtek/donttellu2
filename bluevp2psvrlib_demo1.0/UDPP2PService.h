...
#define JSON_MAINCTRL	"mainctrl"
		...
		public:
			...
			static int json2MainCtrl(const Json::Value &mainctrl, __int64 &llSessionId) throw();
		...
		public:
			...
			static int userData2Json(const std::string &strLanIp, const int &nLanPort,
				const std::string &strMask, bool bMainCtrl,
				const std::string &strId, std::string &strJson) throw();
